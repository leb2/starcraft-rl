...
class Learner:
    def __init__(self, num_actors, env_kwargs, env_interface, run_name='temp', load_model=False):
        ...
        self.weights_path = os.path.join(self.weights_dir, 'weights', 'model.ckpt')
